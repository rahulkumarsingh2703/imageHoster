...
public class ImageController {
    ...
    //First receive the dynamic parameter in the incoming request URL in a string variable 'title' and then Image Id and also the Model type object
    ...
    public String showImage(@PathVariable("id") Integer id, @PathVariable("title") String title, Model model,
        ...
        List<Comment> commentList = commentService.getAllComments(id, title);
    ...
    public String editImage(@RequestParam("imageId") Integer imageId, Model model, HttpSession session,
        ...
        Boolean isLoggedUSer = isUserLoggedIn(image.getUser(), session);
    ...
    private Boolean isUserLoggedIn(User user, HttpSession session) {
